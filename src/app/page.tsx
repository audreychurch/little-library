export default function Home() {
  return (
    <main style={{ fontFamily: "'DM Sans', sans-serif", background: "#FAF8F4", minHeight: "100vh" }}>
      ...
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "1.1rem 2rem", borderBottom: "0.5px solid #E0DDD6" }}>
        <div style={{ fontFamily: "'Lora', serif", fontSize: "17px" }}>
      ...
      <div style={{ padding: "4rem 2rem 2.5rem", maxWidth: "680px" }}>
        ...
        <h1 style={{ fontFamily: "'Lora', serif", fontSize: "38px", fontWeight: 400, lineHeight: 1.2, color: "#1C1A17", marginBottom: "1rem" }}>
          What do you need from a book <em style={{ color: "#7C6F5A" }}>right now?</em>
        </h1>
        <p style={{ fontSize: "15px", color: "#7C6F5A", lineHeight: 1.7, fontWeight: 300 }}>
        ...
        <div style={{ display: "flex", gap: "10px", marginTop: "1.25rem" }}>
          ...
          <span style={{ color: "#C8C3B8", alignSelf: "center" }}>+</span>
          <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#7C6F5A", padding: "5px 12px", border: "0.5px solid #E0DDD6", borderRadius: "999px", background: "#fff" }}>
      ...
      <div style={{ display: "flex", gap: "10px", padding: "0 2rem 0.5rem", overflowX: "auto" }}>
        {["all moods", "need to think", "need to feel", "need to escape", "need to cry", "need to laugh", "need to be scared", "need to be inspired", "can't sleep anyway"].map((mood, i) => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px", padding: "0 2rem" }}>
        {[
          ...
          <div key={card.title} style={{ background: card.bg, borderRadius: "12px", padding: "1.3rem 1.4rem 1.1rem", cursor: "pointer", gridRow: card.tall ? "span 2" : "span 1" }}>
